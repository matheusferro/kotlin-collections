...
fun utilizandoSet(){
    ...
    //OPERACOES ESPECIAIS DE SET
    print(setMutavelAndroid union setMutavelKotlin)
    print(setMutavelAndroid subtract  setMutavelKotlin)
    println(setMutavelAndroid intersect  setMutavelKotlin)
}